...
g++ -std=c++20 -O2 -g ../src/core/vtk_parser.cpp ../src/core/mesh_utils.cpp \
...
g++ -std=c++20 -O2 -g ../vendor/glad/src/gl.c ../src/core/vtk_parser.cpp ../src/core/mesh_utils.cpp \
  ../src/core/stl_parser.cpp ../src/core/obj_parser.cpp ../src/core/mesh_loader.cpp \
...
g++ -std=c++20 -O2 -g ../src/core/vtk_parser.cpp ../src/core/vtk_xml_parser.cpp ../src/core/mesh_utils.cpp \
  ../src/core/stl_parser.cpp ../src/core/obj_parser.cpp ../src/core/mesh_loader.cpp \
