        ...
        Rectangle {
            ...
            Flickable {
                ...
                Column {
                    ...
                    //}
                    // View & Display Controls (grouped by function)
                    Column {
                        id: viewCol
                        ...
                        Text { text: "Camera"; color: "#9cdcfe"; font.pixelSize: 11; font.bold: true }
                        GridLayout {
                    ...
                    Column {
                        ...
                        Column {
                            enabled: backendSettings ? backendSettings.showStreamlines : false
                            spacing: 6
                            width: parent.width
